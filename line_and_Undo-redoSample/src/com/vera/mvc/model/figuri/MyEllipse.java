...
public class MyEllipse implements FigureInterface {
    Ellipse2D.Double myFigure;
    public MyEllipse(){
        myFigure = new Ellipse2D.Double();
    }
    @Override
    ...
    public FigureInterface clone(){
        MyEllipse copy = new MyEllipse();
        copy.myFigure = (Ellipse2D.Double) myFigure.clone();
        return copy;
    }
